(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	(e, t, r) => {
		...
		var S = (w.prototype = new E());
		((S.constructor = w), _(S, g.prototype), (S.isPureReactComponent = !0));
		var T = Array.isArray;
		function j() {}
				...
				!(function e(t, r, n, i, s) {
					...
					if (T(t))
						...
						for (t = h.call(t), h = 0; !(i = t.next()).done; )
							((l = d + R((i = i.value), h++)), (p += e(i, r, n, l, s)));
					else if ('object' === l) {
	...
	(e) => {
		'use strict';
		var t = e.i(4601);
		e.s(['default', 0, () => (0, t.jsx)(t.Fragment, {})]);
	},
	9005,
	(e, t, r) => {
		let n = '/app';
		((window.__NEXT_P = window.__NEXT_P || []).push([n, () => e.r(8568)]),
			t.hot &&
